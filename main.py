...
To override a method in super class, we can define a method with the same name in the super class.// python 2
...
class BadString(Exception):
    ...
    def __str__(self):
        return f'Forbidden character used in {self.s}, Forbidden characters {self.forbid}'

def CheckString(s):
    for a in BadString.forbid:
        if a in s:
            raise BadString(s)
